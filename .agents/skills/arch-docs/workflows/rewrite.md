...
4. Write the root `AGENTS.md` from [../templates/root-AGENTS.md](../templates/root-AGENTS.md). Keep any region a kendex package manages (the review-bot rules region) as the package renders it.
