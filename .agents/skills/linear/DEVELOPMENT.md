...
- Help is inert. `help.sh` is the sole pre-configuration classifier and
  recognizes every help form the command dispatchers accept. Literal `--help`
  option data is not reclassified.
