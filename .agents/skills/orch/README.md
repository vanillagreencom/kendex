...
| `ORCH_OVERSEER_HEADROOM_PCT` | Account headroom at or below which `oversee-succeed` succeeds the overseer, opens no successor, and refuses its turn end through `lane-mail-check` | `20` |
