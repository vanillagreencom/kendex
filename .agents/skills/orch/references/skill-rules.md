...
A source with a tracked render lands that render in the same commit as `skills/AGENTS.md` requires; `ORCH_SIZE_RENDER_ROOTS` names the roots where `branch-size-check` classifies paired mirrors.
