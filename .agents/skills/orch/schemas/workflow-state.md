...
| `dev_delegated_at` | number | Epoch seconds of the round's delegation. The watchdog and `round-recover` read it; [`../references/skill-rules.md` § Round Closure](../references/skill-rules.md#round-closure) owns both uses |
