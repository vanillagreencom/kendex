...
The item then relaunches at the next class up, as [oversee.md](oversee.md) § Item Tier assigns it, by the route the checkout leaves it on. `[BRIEF]` is that assignment's `brief=` word:
