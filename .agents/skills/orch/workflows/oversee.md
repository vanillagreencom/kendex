...
- `model-capacity` → resend one continuation line through Pane paste, then re-run the watch. Never relaunch the lane: the selected model stopped one turn, not the session.
