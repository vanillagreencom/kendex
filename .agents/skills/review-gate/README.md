...
- `REVIEW_GATE_DOCS_ONLY = "none"` lets a docs-only PR pass without bot review evidence. The shared CI classifier decides which paths qualify. Review objections and unresolved threads still block.
