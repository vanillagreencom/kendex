...
| `REVIEW_GATE_DOCS_ONLY` | `bot` keeps review evidence mandatory. `none` lets the shared CI docs classifier replace missing bot evidence while objections and unresolved threads still block. |
