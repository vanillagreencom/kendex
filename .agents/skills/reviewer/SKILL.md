...
- **Duplicated judgment is a finding.** Logic re-answering a question implemented elsewhere in the repo is raised even when both copies agree; name the surviving copy.
