...
- Execute the exact printed wait command until it returns a terminal status. Exit 75 means the run is still active; do other event checks, then rerun the same command.
