...
- `instructions/code-review.md` is this repository's whole review doctrine, and `AGENTS.md` § Code Review Rules is the one directive line sending every review agent to it.
