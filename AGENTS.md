...
- Scope is the reported symptom. Every surface a change touches must trace to a line in the report — if you cannot name that line, file it instead of fixing it, however true the finding is.
