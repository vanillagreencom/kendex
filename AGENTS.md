...
- Scope is the reported symptom. Every surface a change touches must trace to a line in the report — if you cannot name that line, keep it out of this change, however true the finding is; file it only when it clears the bar for filing.
