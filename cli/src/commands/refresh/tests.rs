...
pub(in crate::commands::refresh) fn git_ok(dir: &Path, args: &[&str]) -> bool {
...
pub(in crate::commands::refresh) fn init_repo_with_commit(dir: &Path) -> bool {
...
pub(in crate::commands::refresh) fn write_colliding_source(
    source: &Path,
    marker: &str,
    hook_event: &str,
    model: &str,
