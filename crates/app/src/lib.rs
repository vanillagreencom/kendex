...
pub fn specta_builder() -> Builder<tauri::Wry> {
    let builder = constants(Builder::<tauri::Wry>::new()).commands(collect_commands![
        ...
        commit_offer::commit_offer_baseline,
        commit_offer::commit_offer_scan,
        commit_offer::commit_offer_open,
        commit_offer::commit_offer_file_changes,
        commit_offer::project_changes_scan,
        commit_offer::project_changes_restore_plan,
        commit_offer::project_changes_restore,
