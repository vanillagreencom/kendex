...
/// The file every render in a project depends on: the inventory that records
/// which paths kendex owns here. A commit that adds or removes a render
/// without it records a set that no longer matches the tree.
///
