...
//!
//! One test is not that shape. A markdown extension can turn an indented
//! code block into prose, which quiets every switch inside it, so which
//! dialect the audit reads is a security decision, and the footnote case
