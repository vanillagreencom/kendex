...
| The ruleset, the merge queue | the repository, until the organization rulesets of [D003](../decisions/D003-one-merge-path.md) replace each per-repository one | set in GitHub, never rendered | KEN-1602, KEN-1778 |
