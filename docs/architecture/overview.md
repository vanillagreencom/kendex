...
- The kendex app and CLI open no pull request in a consumer. The consumer train carries each merge to a shipped catalog path there; [D003](../decisions/D003-one-merge-path.md) replaces it with a consumer-run workflow.
