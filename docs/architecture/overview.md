...
- The kendex app and CLI open no pull request in a consumer. The consumer train carries a release in until each consumer runs its own workflow per [D003](../decisions/D003-one-merge-path.md).
