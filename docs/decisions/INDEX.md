...
| 2026-09-25 | D004 | — | Bound the trash by age and size; state that mirrors are kept | Removal never deleted, so a host filled; a mirror bound costs a full clone | A mirror dominates a cache measurement, or the pass shows in apply latency | Active | [Full](D004-trash-retention.md) |
