...
| 2026-09-25 | D003 | — | One merge path through the app-armed queue; consumers pull renders; organization rulesets | A mixed path rebuilds queue groups; the train loads the control VM | Organization rulesets or Actions are unavailable to a served repository | Active | [Full](D003-one-merge-path.md) |
