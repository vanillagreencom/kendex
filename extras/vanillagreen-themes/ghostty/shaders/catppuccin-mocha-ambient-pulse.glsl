...
#define BODY_COL     vec3(0.965, 0.964, 0.998)
#define OUTLINE_COL  vec3(0.796, 0.651, 0.969)
#define FOOT_COL     vec3(0.965, 0.964, 0.998)
#define BLUSH_COL    vec3(0.961, 0.760, 0.906)
#define ACC_COL      vec3(0.0, 0.0, 0.0)
#define ACC2_COL     vec3(0.0, 0.0, 0.0)
#define EYE_COL      vec3(0.796, 0.651, 0.969)
#define EYE_HL_COL   vec3(1.0, 1.0, 1.0)
#define BELL_COL     vec3(0.953, 0.545, 0.659)
#define BELL_OUTLINE vec3(0.796, 0.651, 0.969)
