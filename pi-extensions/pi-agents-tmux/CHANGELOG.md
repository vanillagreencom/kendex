...
- Dashboard usage parsing now streams transcripts, refreshes terminal tasks through their final transcript update, and evicts fingerprints when tasks leave the retained dashboard set.
