...
- **Breaking**: relative `PI_CODING_AGENT_DIR` values now use `~/.pi/agent`. Set an absolute path to relocate the Pi global root. Project discovery stops before the home directory.
