...
- Task registry locking is cross-process and stale-lock aware; if a killed or stalled Pi process leaves a lock behind, dashboard and Monitor refreshes wait for stale recovery and skip transient lock contention instead of exiting Pi.
