...
export function isAgentBrowserTextInput(data: string): boolean {
...
export function tabNext(current: AgentBrowserTabId, _hasActive: boolean, delta: number): AgentBrowserTabId {
