...
- Pane completion collection persists terminal task state before archiving completion files; if the registry lock is busy, the completion outbox remains in place for the next poll.
