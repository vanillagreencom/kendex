...
for (const row of [
	...
	{ name: "position preserved", urls: ["https://example.com/c", "https://example.com/a", "https://example.com/b"], results: [{ id: "https://example.com/c", text: "identified c" }, { text: "anonymous a" }, { id: "https://example.com/b", text: "identified b" }], statuses: [], expected: { urls: ["https://example.com/c", "https://example.com/a", "https://example.com/b"], content: ["identified c", "anonymous a", "identified b"], failures: undefined } },
	{ name: "singleton remainder", urls: ["https://example.com/a", "https://example.com/b", "https://example.com/c"], results: [{ id: "https://example.com/c", text: "identified c" }, { id: "https://example.com/a", text: "identified a" }, { text: "anonymous b" }], statuses: [], expected: { urls: ["https://example.com/c", "https://example.com/a", "https://example.com/b"], content: ["identified c", "identified a", "anonymous b"], failures: undefined } },
