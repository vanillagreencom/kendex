...
| Key | Renders |
|-----|---------|
| `codex` | the pointed `code_review_path` file, which every bot is sent to, and the `AGENTS.md` section, which is the directive line sending Codex there |
