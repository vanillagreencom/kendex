...
- Write `findings.md` to the path the caller requested, exactly. Given no path, write it to `docs/plans/<slug>.md`, tracked: the planner agent's § Plan Artifacts holds that rule.
