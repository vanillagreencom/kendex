...
- Docs change in the same commit as the code they describe. The `doc-drift-check` hook reports unchanged covering docs as a notice; it does not block a stop.
