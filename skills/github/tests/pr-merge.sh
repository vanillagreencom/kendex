...
assert_contains "$out" ".agents/skills/orch/scripts/queue-wait 123 --json once" "queued exit 75 names the verdict producer by installed path"
...
assert_contains "$out" ".agents/skills/orch/scripts/queue-wait 123 --json once" "auto-merge exit 75 names the verdict producer by installed path"
