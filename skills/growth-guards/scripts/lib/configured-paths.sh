...
# them by a count is what makes each additional pattern shape a additional defect.
GG_PATH_GLOBS=""
GG_PATH_GLOBS_SHOWN=""
GG_PATH_ROOTS=""
...
# with a glob in the middle places whatever reaches ITS depth. A additional pattern
