...
3. Set `LINEAR_TEAM` in committed `vstack.settings.toml` under `[env]`, along with any other non-secret defaults (`LINEAR_FORMAT`, `LINEAR_TEAM_PREFIX`, `LINEAR_AGENT_LABELS`).
