...
# list_ids VARPREFIX ARGS... — run the listing, leaving <prefix>_out and
# <prefix>_err holding stdout and stderr.
list_ids() {
  local prefix="$1"
  shift
  local out
...
list_ids overflow --limit 9223372036854775808
