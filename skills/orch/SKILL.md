...
- **A literal backtick is command substitution to the classifier**, even quoted: author search patterns with the regex hex escape `\x60` (canonical worked example: reviewer SKILL.md § Harness-Safe Shell).
