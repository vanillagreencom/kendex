...
Never for a finding that asks for a product decision the issue does not carry — a new command, a parity feature, a behavior nobody specified: that is declined, since filing it makes a reviewer's preference look like ordered work. Step 0's classes never reach the bar at all.
