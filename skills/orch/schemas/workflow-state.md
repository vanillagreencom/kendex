...
| `launch_queue` | string[] | The items the overseer's last selection chose and has not launched, in launch order, rewritten at each selection. `oversee-report` renders its head as the status report's Next row |
