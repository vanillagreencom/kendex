...
| `recovery_round_id` | string | The round id `round-recover` minted when a stalled round had no report. A stall of that round with no report is exhausted, never re-delegated again |
