...
# bound. tmux_wait_launched, tmux_wait_composer and lane_account_ok read
# ORCH_TMUX_VERIFY_SECS and tmux_wait_remote_prompt reads
# ORCH_LANE_SSH_PROMPT_SECS, and all of them are reached only from open_tmux.
