...
Apply the § 2 manifest edits for this consumer before refresh, so refresh renders the added member and drops the removed one and verify covers the edited manifest.
