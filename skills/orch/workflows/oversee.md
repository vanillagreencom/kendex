...
- `handoff` → the item's lane recorded its handoff and exited: relaunch it per § 4 Hand off a lane. On every surface; the record follows the event line.
