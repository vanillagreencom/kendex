...
require_fixed 'excluding Backlog-state issues under 10 minutes old' 'fresh pipeline (Backlog-born) issues are never bundle candidates'
require_fixed 'and stay eligible at any age, so a creation-time pair still bundles' 'human creation-time pairs still bundle'
