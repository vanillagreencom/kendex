...
require_fixed "$create" 'retargets to that entry'"'"'s existing `target` issue id — never a dangling `#N`' 'dependencies on omitted entries retarget to the existing issue'
