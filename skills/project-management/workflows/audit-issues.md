...
.agents/skills/orch/scripts/reconcile-work-items || [ $? -eq 1 ]
```

`reconcile-work-items` (read-only; exit 1 is findings and is tolerated by the
guard above, exit 2 is a broken sweep and fails the preflight)
