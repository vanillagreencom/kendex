...
- **Research inline (recommended)** — gather what the plan needs now (code, vendor docs, web), write findings to `docs/plans/[FEATURE].md`, and continue with it as `RESEARCH_PATH`. No tracker issue.
