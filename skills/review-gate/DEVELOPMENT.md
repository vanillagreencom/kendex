...
| `tests/lib/merged-sweep-fixtures.sh` | The `gh` stub, the GraphQL fixture builders and the pass runners the merged-sweep suite sources, so that file is arms alone. |
