...
| `REVIEW_GATE_API_RETRY_DELAY_SECONDS` | `2` | Pause between retry attempts. The selftest validates the committed value but replays its battery with the delay pinned to 0 — the pause paces production reads and decides no verdict. |
