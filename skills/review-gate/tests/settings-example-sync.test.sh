...
GATE_KEYS="REVIEW_GATE_CONTEXT REVIEW_GATE_TRUSTED_STATUS_CONTEXTS REVIEW_GATE_CHECKRUN_SKIP_PATTERNS REVIEW_GATE_COMMENT_REVIEWERS REVIEW_GATE_SHA_PREFIX_FLOOR REVIEW_GATE_OUTAGE_CONTEXT REVIEW_GATE_STATUS_PUBLISHER_REJECT REVIEW_GATE_REVIEW_OBJECT_TRUSTED_LOGINS REVIEW_GATE_REVIEW_OBJECT_MIN_STATE REVIEW_GATE_THREADS REVIEW_GATE_API_ATTEMPTS REVIEW_GATE_API_RETRY_DELAY_SECONDS REVIEW_GATE_MAX_RERUN_ATTEMPTS REVIEW_GATE_TRUST_PR_WORKFLOWS"
...
for caveat_key in REVIEW_GATE_TRUSTED_STATUS_CONTEXTS REVIEW_GATE_COMMENT_REVIEWERS REVIEW_GATE_OUTAGE_CONTEXT REVIEW_GATE_STATUS_PUBLISHER_REJECT REVIEW_GATE_TRUST_PR_WORKFLOWS; do
