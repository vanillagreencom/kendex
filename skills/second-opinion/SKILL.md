...
| `SECOND_OPINION_TIMEOUT` | `1080` | CLI timeout in seconds. The default exceeds the ~600s ceiling most agent harnesses put on a foreground shell call: run the script in the background, or pass `--timeout` at or below that ceiling |
