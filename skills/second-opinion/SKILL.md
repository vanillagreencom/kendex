...
| `SECOND_OPINION_CURRENT_MODEL` | (unset) | Model identity of this session; overrides harness detection. Required in Pi/OpenCode (refused until set) |
