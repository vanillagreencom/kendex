...
/** A row where a tool reads one folder through a link somebody else set
 *  up. Keeping it is a bigger move than keeping a plain folder — the folder
 *  itself goes to the trash and links kendex cannot see will break — so it
 *  gets the confirmation that names the folder and every tool. */
  ...
  return (
    <ConfirmDialog
      ...
      destructive={
        ...
        // weighted like the replacement, and like the unmanaged list weighs
        // the same move.
