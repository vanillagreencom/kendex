 ...
 * places hold it. The whole card opens the marketplace's own page, which
 * lists those places and changes none of them, so this card carries no
 * control that changes anything from a list. */
