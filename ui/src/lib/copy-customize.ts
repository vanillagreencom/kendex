...
export const SKILLS_AUTOMATIC =
  "This agent gets these skills automatically. Add one and this agent keeps exactly what you choose.";
export const SKILLS_AUTOMATIC_NONE =
  "This agent gets no skills automatically. Add one and this agent keeps exactly what you choose.";
...
export const SKILLS_AUTOMATIC_UNRECORDED =
  "This agent gets its skills automatically. kendex records which ones the next time it installs here. Add one and this agent keeps exactly what you choose.";
