// The Places tab and the Remove everywhere dialog: what a package's places are
...
export const PROJECTS_TAB = "Places";
export const PROJECTS_HEADING = "Installed in";
export const REMOVE_LABEL = "Remove";
export const UPDATE_ALL_LABEL = "Update all";
/** Both open the one dialog that removes the package from every place kendex
 *  can remove it from, and that dialog lists those places. */
export const DELETE_LABEL = "Remove everywhere";
export const REMOVE_ALL_LABEL = DELETE_LABEL;
...
export const deleteTitle = (name: string): string =>
  `Remove ${name} everywhere?`;
export const DELETE_BODY =
  "kendex moves the files it installed to the trash and no longer updates this package.";
export const DELETE_PLACES_LABEL = "Removes it from";
