...
// My Library, in two tabs. Installed is what is on this machine and keeps
// its location filter; Templates is the person's saved selections, which
// belong to no place and so have no location to filter by. Bookmarks joins
// them later.
